...
(function ($) {
    var configs = {
        ...
        'templateHtml': '<div data-area-text="图片预览区" class="file-uploader-selector file-uploader file-gallery"><div class="uploader-prompt uploader-attention"><span></span></div><div class="file-upload-button"><div>上传图片 <span class="uploading-bar"></span></div><input class="file-input" title="file file input" multiple="multiple" type="file" name="file-file-input"></div><ul  role="region" aria-live="polite" aria-relevant="additions removals" class="file-upload-list-selector img-container file-upload-list"></ul></div>'
    };
    ...
    var uploadFile = function (file, $fileUploader, settings) {
        if (settings.uploadConfig.url) {
            ...
            convertToBase64Url(file, settings);
        }
    ...
    var convertToBase64Url = function (originFile, settings) {
        var fr = new FileReader();
        fr.readAsDataURL(originFile);
